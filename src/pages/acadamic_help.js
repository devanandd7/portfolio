          ...
          <div class="flex flex-wrap w-full mb-20">
            <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
              <b>
                ...
                <h1 class="sm:text-7xl text-3xl  title-font mb-2 text-yellow-300">
                  Acadamic_help
                </h1>
              </b>
            ...
            <p class="lg:w-1/2 w-full leading-relaxed text-gray-300">
              ...
              <br /> <b> 100% free of cost </b>, designed to simplify your
              learning journey!.
            </p>
          </div>
          <div class="flex flex-wrap -m-4">
            <div class="xl:w-1/4 md:w-1/2 p-4">
              <div class="bg-gray-100 p-6 rounded-lg">
                <iframe
                  class="h-40 rounded w-full object-cover object-center mb-6 overflow-hidden"
                  src={pdfUrl}
                  title="PDF Preview"
                />
                ...
                <div class="flex justify-center">
                  <button
                    class="inline-flex text-white bg-indigo-500 border-0 py-1 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"
                    onClick={handleDownload}
                  >
                    Download
                  </button>
                  <button
                    class="ml-1 inline-flex text-white bg-green-700 border-0 py-1 px-6 focus:outline-none hover:bg-green-500 rounded text-lg"
